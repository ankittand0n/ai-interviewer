...
import { Archive, Briefcase, Building, GraduationCap, Mail, MapPin, Phone, Plus, User } from 'lucide-react'
...
export default function CandidatesPage() {
  ...
  useEffect(() => {
    async function loadCandidates() {
      try {
        const response = await fetch('/api/candidates/active')
  ...
  if (loading) {
    return <div className="text-center p-6">Loading candidates...</div>
  }
        ...
        <Card>
          <CardContent className="text-center p-6">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Add candidates to start tracking their interview process
            </p>
          </CardContent>
        </Card>
      ) : (
